...
class IHoi(pl.LightningModule):
    def __init__(self, cfg, **kwargs) -> None:
        ...
        self.enc = ImageSpEnc(cfg,  out_dim=cfg['MODEL']['Z_DIM'], layer=cfg['MODEL']['ENC_RESO'], modality=cfg['DB']['INPUT']) # ImageSpEnc(cfg, out_dim=cfg.MODEL.Z_DIM, layer=cfg.MODEL.ENC_RESO, modality=cfg.DB.INPUT)
